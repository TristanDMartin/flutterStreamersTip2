...
class InsightsFirebaseService extends ChangeNotifier {
  ...
  Future<List<ProfileVideo>> getUserProfileVideos({bool forceRefresh = false}) async {
  ...
  Future<InsightsData?> getVideoInsights(String videoId) async {
    ...
    try {
      ...
      final insightsData = insightsDoc.exists ? (insightsDoc.data() ?? <String, dynamic>{}) : <String, dynamic>{};
  ...
  Stream<InsightsData?> listenToVideoInsights(String videoId) {
    return _firestore
      ...
      final additionalData = cachedInsights != null ? <String, dynamic>{} : <String, dynamic>{};
      
      final insights = _buildInsightsData(videoId, analyticsData, additionalData);
  ...
  Future<void> updateVideoInsights(String videoId, Map<String, dynamic> insightsData) async {
    try {
      await _firestore
          .collection('videoInsights')
          .doc(videoId)
  ...
  Future<Map<String, InsightsData>> getBatchInsights(List<String> videoIds) async {
    ...
    try {
      ...
      for (final doc in analyticsSnapshot.docs) {
        ...
        final insights = _buildInsightsData(videoId, analyticsData, <String, dynamic>{});
  ...
  InsightsData _buildInsightsData(String videoId, Map<String, dynamic> analyticsData, Map<String, dynamic> insightsData) {
...
final insightsFirebaseServiceProvider = ChangeNotifierProvider<InsightsFirebaseService>((ref) {
