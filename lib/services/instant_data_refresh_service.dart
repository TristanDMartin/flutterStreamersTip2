...
class InstantDataRefreshService extends ChangeNotifier {
  static final InstantDataRefreshService _instance = InstantDataRefreshService._internal();
  ...
  Future<void> _refreshUserProfile(WidgetRef? ref) async {
    try {
      ...
      if (userDoc.exists) {
        ...
        debugPrint('✅ User profile data refreshed: ${userData['displayName'] ?? 'Unknown'}');
...
final instantDataRefreshProvider = ChangeNotifierProvider<InstantDataRefreshService>((ref) {
