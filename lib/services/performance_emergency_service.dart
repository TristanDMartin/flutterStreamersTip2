...
class PerformanceEmergencyService {
  static final PerformanceEmergencyService _instance = PerformanceEmergencyService._internal();
  ...
  void _checkPerformanceHealth() {
    if (_frameDropCount > _maxFrameDrops || _bufferOverflowCount > _maxBufferOverflows) {
      if (!_isEmergencyMode) {
        _activateEmergencyMode();
      }
    } else if (_isEmergencyMode && _frameDropCount < _maxFrameDrops / 2 && _bufferOverflowCount < _maxBufferOverflows / 2) {
