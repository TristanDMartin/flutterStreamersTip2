...
class MemoryPressureService {
  ...
  static bool get canLoadImage =>
      _currentImageCount < _maxImageCount && !_isMemoryPressureHigh;
  static bool get canLoadAvatar =>
      _currentAvatarCount < _maxAvatarCount && !_isAvatarPressureHigh;
  ...
  static void _adaptLimitsBasedOnPerformance() {
    ...
    if (recentCleanups > 3) {
      ...
      debugPrint(
          '📉 Reduced memory limits due to frequent cleanups: $_maxImageCount images, $_maxAvatarCount avatars');
      ...
      debugPrint(
          '📈 Increased memory limits due to stable performance: $_maxImageCount images, $_maxAvatarCount avatars');
    }
  }
