...
class SecurityService {
  ...
  String sanitizeInput(String input) {
    ...
    sanitized = sanitized.replaceAll(
        RegExp(r'[^\w\s@.-]'), ''); // Keep only alphanumeric, spaces, @, ., -
  ...
  bool validateFileUpload(
    ...
    // Check file size
    if (!isValidFileSize(fileSizeInBytes, maxSizeInMB: maxSizeInMB)) {
      return false;
    }
  ...
  String sanitizeHtml(String html) {
    ...
    sanitized =
        sanitized.replaceAll(RegExp(r'\s+on\w+\s*=', caseSensitive: false), '');
  ...
  String validateAndSanitizeInput(
    String input, {
    int? minLength,
    int? maxLength,
    bool checkSqlInjection = true,
