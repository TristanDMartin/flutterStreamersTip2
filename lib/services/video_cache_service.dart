...
class VideoCacheService {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      _isInitialized = true;
      // appLog('📦 Video cache initialized: ${_currentCacheSize ~/ 1024}KB');
    } catch (e) {
      // appLog('❌ Error initializing video cache: $e');
    }
  }
  ...
  Future<void> _loadCacheIndex() async {
    try {
      ...
      // appLog('❌ Error loading cache index: $e');
    }
  }
  ...
  Future<void> _saveCacheIndex() async {
    try {
      ...
      // appLog('❌ Error saving cache index: $e');
    }
  }
  ...
  Future<bool> cacheVideo(String videoUrl, File videoFile) async {
    ...
    try {
      ...
      // appLog('📦 Video cached: $videoUrl (${fileSize ~/ 1024}KB)');
      return true;
    } catch (e) {
      // appLog('❌ Error caching video: $e');
      return false;
    }
  }
  ...
  Future<bool> cacheThumbnail(String videoUrl, Uint8List thumbnailData) async {
    ...
    try {
      ...
      // appLog('📦 Thumbnail cached: $videoUrl');
      return true;
    } catch (e) {
      // appLog('❌ Error caching thumbnail: $e');
      return false;
    }
  }
  ...
  Future<void> _cleanupOldestEntries() async {
    ...
    while ((_currentCacheSize > _maxCacheSize ||
            _cacheIndex.length > _maxCacheFiles) &&
  ...
  Future<void> _removeCacheEntry(String key) async {
    ...
    try {
      ...
      final thumbnailFile =
          File(path.join(_cacheDirectory!.path, '${entry.filename}_thumb.jpg'));
      ...
      // appLog('❌ Error removing cache entry: $e');
    }
  }
...
class CacheStatistics {
  ...
  String get formattedMaxSize =>
      '${(maxSize / 1024 / 1024).toStringAsFixed(1)}MB';
