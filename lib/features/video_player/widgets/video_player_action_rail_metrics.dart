...
class VideoPlayerActionRailMetrics {
  ...
  static VideoPlayerActionRailMetrics of(BuildContext context) {
    ...
    final double rightInset = compact ? 12.0 : (small ? 14.0 : 16.0);
    final double buttonSize = compact ? 48.0 : 52.0;
    final double likeWidth = compact ? 52.0 : 56.0;

    return VideoPlayerActionRailMetrics(
      leftInset: responsive.spacing(compact ? 20 : 24),
      rightInset: rightInset,
      metadataRightInset: rightInset + likeWidth + (compact ? 10.0 : 16.0),
