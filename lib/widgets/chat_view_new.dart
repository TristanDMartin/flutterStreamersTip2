            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildDebugRow("Auth", FirebaseAuth.instance.currentUser != null ? "✅" : "❌"),
                  _buildDebugRow("Chat ID", widget.chat.id ?? "nil"),
                  _buildDebugRow("Participants", "${widget.chat.participants.length}"),
                  _buildDebugRow("Messages", "${ref.watch(chatProvider(widget.chat)).messages.length}"),
                  _buildDebugRow("Loading", ref.watch(chatProvider(widget.chat)).isLoading ? "Yes" : "No"),
