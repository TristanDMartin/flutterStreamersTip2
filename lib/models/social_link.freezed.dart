...
extension SocialLinkPatterns on SocialLink {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, SocialLinkType type, String url)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _SocialLink() when $default != null:
        return $default(_that.id, _that.type, _that.url);
      case _:
        return orElse();
    }
  }
...
class _SocialLink implements SocialLink {
  const _SocialLink({required this.id, required this.type, required this.url});
