 ...
 *
 * Usage (emulator):
 *   FIRESTORE_EMULATOR_HOST=127.0.0.1:8080 DRY_RUN=true node scripts/backfill_follows_uid.js
 *
 * Usage (prod read-only dry run — recommended):
 *   DRY_RUN=true node scripts/backfill_follows_uid.js
 *
 * Usage (prod write — only after dry run and backup):
 *   DRY_RUN=false node scripts/backfill_follows_uid.js
 */
